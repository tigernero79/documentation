...
The Raspberry Pi 3B+ is able to boot from USB without any changes, but the Raspberry Pi 3A+ and 3B require the USB boot bit to be set in the OTP (one-time programmable) memory. If you are using a Raspberry 3B+, please go to the next section.
